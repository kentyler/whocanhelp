...
<style>
   ...
   .plusminus{font-family:verdana,sans-serif;font-size:14px;width:50px;}
	
 @media only screen and (max-device-width: 480px) {
   body {font-family:verdana,sans-serif;font-size:36px;}
   .plusminus{font-family:verdana,sans-serif;font-size:36px;width:50px;}
   input{font-size:36px;}
   table tr td {font-size:36px;}
 }
 </style>
 <script>
